...
st.set_page_config(
    ...
    page_title="ðŸŽ Apple AI Trading Dashboard",
...
class AppleAITradingDashboard:
    ...
    âŒ No real-time data â†’ âœ… Live pipeline integration

    âŒ No XAI explanations â†’ âœ… Interactive explanation widgets

    âŒ Static displays â†’ âœ… Dynamic, updating visualizations

    âŒ No Apple focus â†’ âœ… Company-specific analytics

    âŒ No agent coordination â†’ âœ… Multi-agent decision center
    ...
    def load_data(self):
        ...
        try:
            ...
            with st.spinner("ðŸ”„ Loading Apple data and AI models..."):
                ...
                if config.NEWS_API_KEY:
                    ...
                    st.error("âŒ NEWS_API_KEY not found. Please configure in .env file")

                   

        except Exception as e:

            st.error(f"âŒ Data loading failed: {str(e)}")
    ...
    def render_header(self):
        ...
        <div style='text-align: center; padding: 1rem; background: linear-gradient(90deg, #1f2937, #374151); border-radius: 10px; margin-bottom: 2rem;'>
            ...
            <h1 style='color: white; margin: 0;'>ðŸŽ Apple AI Trading Command Center</h1>
        ...
        with col2:
            ...
            st.metric("ðŸ¤– AI Models", "Active", delta="FinBERT + XAI")
        ...
        with col3:
            ...
            st.metric("ðŸ“° News Articles", news_count, delta="Last 7 days")
        ...
        with col4:
            ...
            st.metric("ðŸŽ¯ AI Confidence", f"{confidence:.1%}",
    ...
    def render_trading_signals(self):
        ...
        st.markdown("## ðŸŽ¯ AI Trading Signals & Explanations")
    ...
    def render_sentiment_analysis(self):
        ...
        st.markdown("## ðŸ§  News Sentiment Analysis with XAI")
        ...
        with col2:
            ...
            fig_timeline = px.line(
                ...
                title="ðŸ“ˆ Sentiment Trend (7 Days)",
        ...
        st.markdown("### ðŸ“° Article-Level Analysis")
    ...
    def render_article_xai_analysis(self, article):
        ...
        with col1:
            ...
            st.markdown("#### ðŸ“ Article Content")
        ...
        with col2:
            ...
            if article.influential_words:
                ...
                st.markdown("ðŸŽ¯ Most Influential Words:")
    ...
    def render_stock_analysis(self):
        ...
        st.markdown("## ðŸ“ˆ Apple Stock Technical Analysis")

       

        if 'stock_data' not in self.current_data:

            st.warning("âš  No stock data available")
        ...
        fig.update_layout(height=800, title="ðŸŽ Apple Stock Comprehensive Analysis")
    ...
    def render_performance_metrics(self):
        ...
        st.markdown("## ðŸ“Š AI Trading Performance")
...
def render_control_panel(self):
        ...
        st.sidebar.markdown("## âš™ AI Control Panel")

       

        # Model controls

        st.sidebar.markdown("### ðŸ¤– Model Settings")
        ...
        st.sidebar.markdown("### ðŸ” XAI Settings")
...
def render_news_analysis_detailed(self):
        ...
        st.markdown("## ðŸ“° Advanced News Analysis")

       

        if not self.current_data.get('news_data'):

            st.warning("âš  No news data available")
        ...
        for i, article in enumerate(filtered_articles):
            ...
            with st.expander(f"ðŸ“° {article.title[:80]}..." if len(article.title) > 80 else article.title):
...
def render_model_performance_analysis(self):
        ...
        st.markdown("## ðŸ§  AI Model Performance Analysis")
